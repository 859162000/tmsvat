...
rem ---------------------------------------------------------------------------
set JAVA_HOME=c:\server\java\1.7_64
set CATALINA_HOME=C:\server\tomcat0
...
set SERVICE_NAME=Tomcat7_0
set PR_DISPLAYNAME=Tomcat7_0
...
"%EXECUTABLE%" //US//%SERVICE_NAME% ++JvmOptions "-Dorg.apache.jasper.runtime.BodyContentImpl.LIMIT_BUFFER=true;-Dmail.mime.decodeparameters=true;-Djava.io.tmpdir=%CATALINA_BASE%\temp;-Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager;-Djava.util.logging.config.file=%CATALINA_BASE%\conf\logging.properties;-XX:PermSize=256m;-XX:MaxPermSize=512m;-Dfile.encoding=utf-8" --JvmMs 2048 --JvmMx 61440
