...
<#if field.getIsSampleField()>
    ...
    <Control id="btnQuery" width="80" command="cmdQuery" type="Button" value=" "  style="find" />
...
if (record != null) {&#xD;
  ...
  -->
  	<Control style="export" id="buttonExport" command="commandExport" type="Button" value=" "/>
  	<Control templateTable="tblEntity" id="commandExport" dataset="dsEntity" type="Export2ExcelCommand">
      <Frame target="_self"/>
      <Parameters/>
      <Events>
        <Event name="beforeExecute">if(tblEntity.getFirstRecord() == null) {	&#xD;
  alert(&quot;没有要导出的数据,请先查询后再操作！&quot;);&#xD;
  return false;&#xD;
}</Event>
      </Events>
    </Control>
    <Control openMode="subwindow" id="dropdownDivision" width="400" fixed="true" type="CustomDropDown" height="400" path="../../../support/dropdownDivision.jsp?limitShow=02">
      <Events>
        <Event name="onSelect">dsQuery.setValue(&quot;divName&quot;,selectedObject.getValue(&quot;orgName&quot;));
dsQuery.setValue(&quot;divid&quot;,selectedObject.getValue(&quot;id&quot;));</Event>
      </Events>
    </Control>
  </Controls>
  <Properties/>
