...
\#dataType${declarationName}Param.#${field.getName()}=${field.getASCIIComment()}
			<#else>
...
<#foreach field in fields>
	<#if field.getIsSampleField()>
		<#if field.getComment()?exists>
\#dataTypeQuery${declarationName}.#${field.getName()}=${field.getASCIIComment()}
			<#else>
\#dataType${declarationName}Param.#${field.getName()}=${field.getName()}
		</#if>
	</#if>
...
<#assign fields=child.getPojoFields()>
	<#foreach field in fields>
		<#if field.getIsSampleField()>
			<#if field.getComment()?exists>
\#dataType${childdeclarationName}Param.#${field.getName()}=${field.getASCIIComment()}
				<#else>
