...
public class ${declarationName}DaoImpl extends BaseDao<${declarationName}> implements ${declarationName}Dao{
	...
	public String uniqueCheck(String id){
		String hql = "select count(*) from " + ${declarationName}.class.getName() + " d where d.id = :id";
	...
	public List<${declarationName}> findAll${declarationName}s(){
		StringBuffer query=new StringBuffer();
		Map values=new HashMap<String, Object>();
		query.append("FROM ${declarationName} ");
		return findBy(query, values);
	}
