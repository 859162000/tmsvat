...
public class TableDesToClassExporter {
	// 输出文件默认目录
	String rootdir_str;
	TableDes table;
	String template_str;
	...
	static final Log log = LogFactory.getLog(TableDesToClassExporter.class);

	private TableDesToClassExporter() {

	}

	public TableDesToClassExporter(String baseDir, TableDes table, String template,
			String result) {
