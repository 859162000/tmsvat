...
public class ChineseSpellingUtils {
	...
	private static ChineseSpellingUtils chineseSpelling = new ChineseSpellingUtils();

	public static ChineseSpellingUtils getInstance() {
	...
	public String getFirstSelling(String chs) {
		String key, value;
		buffer = new StringBuilder();
		for (int i = 0; i < chs.length(); i++) {
			key = chs.substring(i, i + 1);
	...
	public String getFirstSelling() {
		return this.getFirstSelling(this.getResource());
	}
	public static void main(String[] args) {
		ChineseSpellingUtils finder = ChineseSpellingUtils.getInstance();        
         finder.setResource("中文字符");        
         System.out.println(finder.getFirstSelling());        
         System.out.println(finder.getFirstSelling("英文字符Eng"));   
	}
