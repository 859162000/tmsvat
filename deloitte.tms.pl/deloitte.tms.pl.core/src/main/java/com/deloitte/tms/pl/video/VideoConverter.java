package com.deloitte.tms.pl.video;
import java.io.File;
...
public class VideoConverter {
	...
	private final static String DEFAULT_VIDEO_DES_PATH = "";
	private final static String DEFAULT_FLV_PATH = "D:\\server\\ffmpeg\\bin";
	
	
        private final static String BASE_PATH = DEFAULT_VIDEO_DES_PATH;
        private final static String FLV_PATH = DEFAULT_FLV_PATH;
