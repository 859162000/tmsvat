...
package com.deloitte.tms.pl.jsonresponse.constant;
...
public abstract class HttpConstants {
	...
	public static final String AJAX_TYPE_TEXT="x-www-form-urlencoded";
	public static final String AJAX_TYPE_JSON="application/json";
