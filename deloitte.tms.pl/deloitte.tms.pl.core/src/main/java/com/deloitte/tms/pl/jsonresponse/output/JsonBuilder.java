...
import com.deloitte.tms.pl.core.commons.exception.IllegalJsonFormatException;
...
public class JsonBuilder {
	...
	public JsonBuilder(StringBuilder w) {
		comma = false;
		state = 'i';
	...
	public JsonBuilder(StringBuilder w, boolean reuseable) {
		this(w);
