...
//package com.ling2.core.dao.impl;
//
...
//
//import com.ling2.core.commons.enums.DataStatus;
//import com.ling2.core.commons.support.DaoPage;
//import com.ling2.core.commons.utils.AssertHelper;
//import com.ling2.core.commons.utils.CriteriaUtils;
//import com.ling2.core.commons.utils.DateUtils;
//import com.ling2.core.commons.utils.HqlUtils;
//import com.ling2.core.commons.utils.PageUtils;
//import com.ling2.core.commons.utils.SpringUtil;
//import com.ling2.core.commons.utils.reflect.ReflectUtils;
//import com.ling2.core.commons.utils.reflect.criteria.PropertyCriteria;
//import com.ling2.core.commons.utils.reflect.criteria.PropertyCriteriaFactory;
//import com.ling2.core.commons.utils.reflect.criteria.PropertyRestrictions;
//import com.ling2.core.commons.utils.support.DateSubstitute;
//import com.ling2.core.dao.EntityOperation;
//import com.ling2.core.dao.IDao;
//import com.ling2.core.dao.ISecurity;
//
//public class BaseDaoSimple<T> extends HibernateDaoSupport implements IDao<T> {
//	ISecurity security;
//	
...
//					}
//				} else {
//					Object persistentObject = getHibernateTemplate().get(
...
//					throws HibernateException, SQLException {
//				@SuppressWarnings("unchecked")
//				Connection conn = session.getSessionFactory();
...
//							prep.setString(iTmp, oIn[j].toString());
//						}
//					}
//
//					ResultSet resultSet = prep.executeQuery();
//					ResultSetMetaData resultsm = resultSet.getMetaData();
//					while (resultSet.next()) {
//						Object[] o = new Object[resultsm.getColumnCount()];
//						for (int i = 1; i < resultsm.getColumnCount() + 1; i++) {
//							if (resultSet.getObject(i) == null) {
//								o[i - 1] = null;
//							} else if (resultSet.getObject(i) instanceof Timestamp) {
//								o[i - 1] = resultSet.getObject(i);
//							} else {
//								o[i - 1] = resultSet.getObject(i).toString();
//							}
//						}
//						list.add(o);
//					}
...
//
//		return (DaoPage) getHibernateTemplate().execute(new HibernateCallback() {
//			public Object doInHibernate(Session session)
//					throws HibernateException, SQLException {
...
//				int recordCount =Integer.parseInt(executableCriteria.setProjection(
...
//
//				if (identiferValue != null) {
//					Object entitiy = getHibernateTemplate().get(obj.getClass(),
//							identiferValue);
//					remove(entitiy);
//				}
//			}
...
//					save(obj);
//				} else {
//					Object entity = getHibernateTemplate().get(obj.getClass(),
//							identiferValue);
//
...
//		Object resutlt=getHibernateTemplate().execute(new HibernateCallback() {
//
...
//			}
//		});
//		return Integer.parseInt(resutlt.toString());
//	}
//	/**
//	 * @param sql
//	 * @param values
...
//	}
//	private int queryForInt(final String hql,final Object[] parameters,final Map<String,Object> parameterMap,String dataSourceName){
...
////		return result;
////	}
//	public List findBy(final String query, final Map<String, Object> values) {
//		Assert.notNull(query);
//		Assert.notNull(values);
//
//		return (List) getHibernateTemplate().execute(new HibernateCallback() {
...
//	 * @return
//	 */
//	public List findBy(StringBuffer query, final Map values) {
//		Assert.notNull(query);
//		Assert.notNull(values);
//
//		final String queryString = query.toString();
