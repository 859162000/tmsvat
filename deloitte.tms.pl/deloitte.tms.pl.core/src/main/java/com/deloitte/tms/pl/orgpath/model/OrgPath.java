package com.deloitte.tms.pl.orgpath.model;
...
@Entity
@Table(name = OrgPath.TABLE)
public class OrgPath extends BaseEntity{
	
	public static final String TABLE = TablePreDef.BASEPRE+"org_path";
