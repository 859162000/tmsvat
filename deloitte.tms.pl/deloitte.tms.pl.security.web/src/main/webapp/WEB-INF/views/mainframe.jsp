...
<body class="easyui-layout">
	...
	<div region="west" border="true" split="true" title="Navigation" class="cs-west">
		<div class="easyui-accordion" fit="true" border="false">
				<div title="Base">
				    <a href="javascript:void(0);" src="functionmaintain.ljson" class="cs-navi-tab"><spring:message code="mainframe.menumaintain"/>菜单管理</a></p>
					<a href="javascript:void(0);" src="demo/easyloader/basic.html" class="cs-navi-tab">用户管理</a></p>
					<a href="javascript:void(0);" src="demo/draggable/constain.html" class="cs-navi-tab">角色管理</a></p>
					<a href="javascript:void(0);" src="demo/draggable/constain.html" class="cs-navi-tab">权限管理</a></p>
	...
	<div region="south" border="false" class="cs-south">wwwww</div>
