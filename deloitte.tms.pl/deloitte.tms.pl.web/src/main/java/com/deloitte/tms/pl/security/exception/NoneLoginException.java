...
import com.deloitte.tms.pl.security.security.session.SessionInformationObject;
import com.deloitte.tms.pl.security.security.session.SessionStateConstants;
...
public class NoneLoginException extends AuthenticationException {
	...
	public NoneLoginException(String msg) {
		...
		if(state==null){
			SessionRegistry sessionRegistry=ContextHolder.getBean("ling2.sessionRegistry");
