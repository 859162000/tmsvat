...
@Entity
@Table(name = TablePreDef.BASEPRE+"EXCEL_MODEL")
public class ExcelModel implements java.io.Serializable {
	...
	@Column(name = "PROCESSOR_TYPE_", length = 120)
	...
	@ModelProperty(comment="自定义excel解析实现接口")
	@Column(name = "excelParser", length = 60)
	private String excelParser;
	@ModelProperty(comment="自定义excel导入数据预览页面")
	@Column(name = "previewPage", length = 60)
	private String previewPage;
	
	//
	@Column(name = "modelDetailProvider", length = 120)
	private String modelDetailProvider;
	@Transient
	...
	public String getModelDetailProvider() {
		return modelDetailProvider;
	}

	public void setModelDetailProvider(String modelDetailProvider) {
		this.modelDetailProvider = modelDetailProvider;
	}

	public String getExcelParser() {
		return excelParser;
	}

	public void setExcelParser(String excelParser) {
