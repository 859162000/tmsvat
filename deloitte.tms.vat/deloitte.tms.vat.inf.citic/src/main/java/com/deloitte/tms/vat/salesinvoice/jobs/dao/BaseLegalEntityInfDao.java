...
public interface BaseLegalEntityInfDao extends IDao<BaseLegalEntityInf> {
	
	public static final String BEAN_ID = "BaseLegalEntityInfDao";
	 ...
	 * @since [产品/模块版本] （可选）
	 */
	public List<BaseLegalEntityInf> findBaseLegalEntityInf(Map<String,Object> params);
