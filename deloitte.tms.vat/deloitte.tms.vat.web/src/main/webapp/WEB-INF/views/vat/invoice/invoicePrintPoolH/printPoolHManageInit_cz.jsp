...
<script type="text/javascript">
	...
	function pageDataSettingInit(){
		...
		$('#printPoolHManageInit_searchform_appOrgCode').combogrid({
			url:'${vat}/invoicePrintPoolH_cz/loadApplyOrgListForInvoicePrint.do',
	            ...
	            onDblClickRow:function(index,data){
	            	...
	            	row_1[0].target.combogrid({
            			...
            			textField : 'equipmentCode',  
               		 	url:"${vat}/invoicePrintPoolH_cz/loadLegalEntityForInvoicePrint.do",
	               		fitColumns : true,
	         			striped : true,
	         			editable : true,
	         			rownumbers : true, //序号
            				...
            				$.messager.confirm("提示","确认保存打印终端?",function(result){
            	    			if(result){
            	    				...
            	    				var urlString="equipmentName="+select_record.equipmentName;
            	    					...
            	    					$.post('${vat}/invoicePrintPoolH_cz/saveLegalEntityForInvoicePrint.do',
            	    						{
            	    					...
            	    					'json');
            	    				/* $.ajax({  
            	    			        url: "${vat}/invoicePrintPoolH_cz/saveLegalEntityForInvoicePrint.do",  
            	    			        type: "POST",  
            	    			        async: true,  
	...
	function printPoolHManageInit_Search(){
    	...
    	$('#printPoolHManageInit_searchform').form('submit', {
			url:'${vat}/invoicePrintPoolH_cz/loadInvoicePrintPoolHPage.do',			
			onSubmit : function(){
...
//发票状态初始化		
		/* $.ajax({  
	        url: "${vat}/invoicePrintPoolH_cz/poolManagePrintStatus.do",  
	        type: "POST",  
	        async: true,  
    ...
    function printPoolHManageInit_printSubmit(){
		...
		//alert("获取发票代码和发票No  发票数量："+row_list.length);
    		...
    		var id='';
    		 ...
    		 if(id!=''){
     			...
     			$.ajax({  
     		        ...
     		        url: "${vat}/invoicePrintPoolH_cz/loadInvoicePrintPoolHDetail.do",
     		        type: "POST",  
     		        async: true,  
     		        data: urlString, //不能直接写成 {id:"123",code:"tomcat"}  
     		        dataType: "json",  
    ...
    function printPoolHManageInit_poolD_view(index,data){
        	...
        	$.ajax({  
    	        url: "${vat}/invoicePrintPoolH_cz/getInvoicePrintPoolDInParamDetailList.do",
    	        type: "POST",  
    	        async: true,  
    	        data: urlString, //不能直接写成 {id:"123",code:"tomcat"}  
    	        dataType: "json",  
