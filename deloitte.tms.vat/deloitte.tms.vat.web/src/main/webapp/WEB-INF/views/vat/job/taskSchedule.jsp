...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<div region="north" split="true" border="false"
		...
		<div class="easyui-panel" title=""
			style="width: 100%; height: 0%; background-color: #E0ECFF">
	...
	<div data-options="region:'center',border:false"
		...
		<div id="taskSchedule_addOrEdit_dlg" class="easyui-dialog"
			style="width: 800px; height: 100%;" closed="true"
			...
			<form id="taskSchedule_editform" class="easyui-form" method="post"
				...
				<table>
					<tr>
						...
						<td><input class="easyui-validatebox" id="nameInDialog"
							required="true" missingMessage="name 必填" style="width: 150px;"
							type="text" name="name"></input></td>

					</tr>
					<tr>
						<td><spring:message code="taskSchedule.usedBeanId" />：</td>
						<td><input class="easyui-validatebox" id="beanIdInDialog"
							required="true" missingMessage="beanID必填" style="width: 150px;"
							type="text" name="beanId"></input></td>
					</tr>

					<tr>
						<td><spring:message code="taskSchedule.cronExpression" />：</td>
						<td><input class="easyui-validatebox"
							id="cronExpressionInDialog" required="true"
							missingMessage="表达式必填" style="width: 150px;" type="text"
							name="cronExpression"></input></td>
					</tr>
					<tr>
						<td><spring:message code="taskSchedule.comments" />：</td>
						<td><input class="easyui-validatebox" id="descInDialog"
							required="true" missingMessage="描述必填" style="width: 150px;"
							type="text" name="desc"></input>
					</tr>
					<tr style="display: none">
...
<script type="text/javascript">
				...
				.datagrid(
						{
							...
							columns : [ [
									...
									{
										field : 'state',
										title : '<spring:message code="taskSchedule.state"/>',
										width : 80,
										align : 'center'
									}, 
	...
	function SearchHistory() {
		...
		if (($('#taskScheduleInit_dataGrid').datagrid('getChecked').length == 0)
			...
			$.messager.alert("操作提示", "请选择需要查看的一条jobs！");
			$('#taskScheduleInit_dataGrid').datagrid('clearSelections');
			return;
		} 
		var itm = $('#taskScheduleInit_dataGrid')	.datagrid('getChecked')[0].id;
				...
				$.ajax({
					...
					success : function(result) {
						...
						if (result.success == 'false') {
							$.messager.alert('<spring:message code="system.alert"/>','<spring:message code="system.delete.fail.text"/>' + "," +result.errorMsg);
						} else {
							$.messager.alert('<spring:message code="system.alert"/>', '调用成功');
							Search();
						}
